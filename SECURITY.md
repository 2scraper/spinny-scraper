...
**"spinny-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing Spinny's bot protection.** This scraper drives an ordinary
...
- **The scraper stopped working.** Spinny changing its markup is expected —
